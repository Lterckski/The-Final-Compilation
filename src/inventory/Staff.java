...
public class Staff extends Weapon{
    ...
    public static final Staff APPRENTICE_STAFF = new Staff("Apprentice's Staff", "\uD83D\uDFE2", 5, 50, 0);
    ...
    public boolean applyEffects(Character target, int damage) {
        ...
        if(RandomUtil.chance(confuseChance)){
            if(this == APPRENTICE_STAFF) {
                System.out.println("\uD83C\uDF00 Simon has resorted to smacking " + target.getName() + " and managed to hit their head! "  + target.getName() + " is in a daze!");
            }
