...
public class StoryEngine {
    ...
    private void intro() {
        ...
        while (start != 1) {
            ...
            System.out.println("Press " + ColorUtil.boldBrightGreen("1") + " to START the exam");
            ...
            if (start != 1) {
                System.out.println(ColorUtil.boldBrightRed("❌ Invalid choice! Please press 1 to start."));
            }
        }
