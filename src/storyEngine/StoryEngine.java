            ...
            switch (choice) {
                case 1 -> {
                    ...
                    if (characterMenu(kael)) {
                        ...
                        try {
                            // Delay 1 second before showing the first ASCII banner
                            Thread.sleep(1000);
                            System.out.println();
                            System.out.println("        ▄█   ▄█▄    ▄████████    ▄████████   ▄█            ");
                            System.out.println("       ███ ▄███▀   ███    ███   ███    ███  ███            ");
                            ...
                            // Delay 1 second before showing the silhouette ASCII
                            Thread.sleep(1000);
                ...
                case 2 -> {
                    ...
                    if (characterMenu(karl)) {
                        ...
                        try {
                            // Delay 1 second before showing the first ASCII banner (letters)
                            Thread.sleep(1000);
                            System.out.println();
                            System.out.println("       ▄█   ▄█▄    ▄████████    ▄████████   ▄█            ");
                            System.out.println("      ███ ▄███▀   ███    ███   ███    ███  ███            ");
                            ...
                            // Delay 1 second before showing the silhouette ASCII (model)
                            Thread.sleep(1000);
                            System.out.println("                                 +                        ");
                            System.out.println("                                   +  -                   ");
                            System.out.println("                                      +- .:               ");
                ...
                case 4 -> {
                    ...
                    if (characterMenu(test)) {
                        ...
                        try {
                            ...
                            // Delay 1 second before showing the ASCII banner
                            Thread.sleep(1000);
                            System.out.println(" %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% ");
                            System.out.println(" %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% ");
                            System.out.println(" %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%######************#####%%%%%%%%%%%%%%%%%%%%%%%%%%%%% ");
